...
int[] buttonFrameForward = {150,150,100,100};
String buttonStringForward = "Forward";
int[] buttonFrameBackward = {150,400,100,100};
String buttonStringBackward = "Backward";
int[] buttonFrameRotateL = {75,275,100,100};
String buttonStringRotateL = "RotateL";
int[] buttonFrameRotateR = {225,275,100,100};
String buttonStringRotateR = "RotateR";
int[] buttonFrameChangeM = {300,75,50,50};
String buttonStringChangeM = "Start/Stop";
...
void draw() {
  ...
  drawButton(buttonFrameRotateL,buttonStringRotateL);
  drawButton(buttonFrameRotateR,buttonStringRotateR);
  drawButton(buttonFrameChangeM,buttonStringChangeM);
...
void mousePressed() {
   ...
   if (mouseInside(buttonFrameRotateL)) {
      btWrite("L");  
   } else 
   if (mouseInside(buttonFrameRotateR)) {
      btWrite("R");  
   } else 
   if (mouseInside(buttonFrameChangeM)) {
      btWrite("G");  
   }
}